...
// A kickoff we do not have is not a kickoff. new Date(null) is the epoch and
// formats as "01:00" -- a missing time reads as a match in the early hours
// rather than as missing -- and an unparseable one renders the words "Invalid
// Date" beside the fixture. Same rule as the price: show a dash.
function fmtTime(d){
  const t=new Date(d);
...
module.exports = async (req, res) => {
  ...
  const recordPhrase = total > 0
    ? `Data-driven predictions with ${winRate}% win rate on basketball.`
...
<div class="wrap">
  ...
  <div class="tips-grid">
    ${tipCards||'<p style="color:#6c83a3;grid-column:1/-1">No NBA tips published yet. The card goes up each morning, UK time, when there are fixtures to price.</p>'}
...
<footer>
  <p style="margin-bottom:10px">© 2026 The Tipster · Free NBA betting tips · 18+ only · Tips are for informational purposes only · Past performance does not guarantee future results · Please gamble responsibly &bull; <a href="https://www.begambleaware.org" target="_blank" rel="noopener noreferrer">BeGambleAware.org</a> &bull; National Gambling Helpline <a href="tel:08088020133">0808 8020 133</a></p>
